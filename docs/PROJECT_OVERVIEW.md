...
- **UltraSplits**, **Ultra Planner**, **Ready for Ultra**, and **My Pace
  Chart**: split predictors and spreadsheet builders, not tied to a specific
  race's cutoffs.
...
- **Verify the 2026 cutoff numbers** in `data/cutoffs_2026_100m.csv` and
  `cutoffs_2026_100k.csv` against the official published schedule (the loader is
  correct; the source values need a human eyeball). Use the tick-box checklist
  in [`CUTOFF_VERIFICATION.md`](CUTOFF_VERIFICATION.md), which lists every
  current value.
